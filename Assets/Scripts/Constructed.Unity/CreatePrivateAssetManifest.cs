        ...
        private static CreatePrivateAssetManifest Build()
        {
            return new CreatePrivateAssetManifest(new[]
            {
                ...
                Item("create:cogwheel", "Cogwheel",
                    Generated("models/item/cogwheel.json"),
                    Main("models/block/cogwheel.json"),
                    Main("models/block/large_wheels.json"),
                    Main("textures/block/cogwheel.png"),
                    Main("textures/block/cogwheel_axis.png"),
                    Main("textures/block/axis_top.png"),
                    Minecraft("textures/block/stripped_spruce_log_top.png")),

                Item("create:large_cogwheel", "Large Cogwheel",
                    Generated("models/item/large_cogwheel.json"),
                    Main("models/block/large_cogwheel.json"),
                    Main("models/block/large_wheels.json"),
                    Main("textures/block/large_cogwheel.png"),
                    Main("textures/block/cogwheel_axis.png"),
                    Main("textures/block/axis_top.png"),
                    Minecraft("textures/block/stripped_spruce_log.png")),

                Item("create:gearbox", "Gearbox",
                    Generated("models/item/gearbox.json"),
                    Main("models/block/gearbox/item.json"),
                    Main("textures/block/andesite_casing.png"),
                    Main("textures/block/gearbox.png"),
                    Main("textures/block/axis.png"),
                    Main("textures/block/axis_top.png")),
                ...
                Block("create:cogwheel", "Cogwheel Block",
                    Generated("blockstates/cogwheel.json"),
                    Main("models/block/cogwheel.json"),
                    Main("models/block/cogwheel_shaftless.json"),
                    Main("models/block/cogwheel_shaft.json"),
                    Main("models/block/large_wheels.json"),
                    Main("textures/block/cogwheel.png"),
                    Main("textures/block/cogwheel_axis.png"),
                    Main("textures/block/axis_top.png"),
                ...
                Block("create:large_cogwheel", "Large Cogwheel Block",
                    Generated("blockstates/large_cogwheel.json"),
                    Main("models/block/large_cogwheel.json"),
                    Main("models/block/large_cogwheel_shaftless.json"),
                    Main("models/block/cogwheel_shaft.json"),
                    Main("models/block/large_wheels.json"),
                    Main("textures/block/large_cogwheel.png"),
                    Main("textures/block/cogwheel_axis.png"),
                ...
                Block("create:gearbox", "Gearbox Block",
                    Generated("blockstates/gearbox.json"),
                    Generated("models/item/gearbox.json"),
                    Main("models/block/gearbox/block.json"),
                    Main("models/block/gearbox/item.json"),
